...
def fix_imports(file_path: Path) -> bool:
    ...
    replacements = [
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.interfaces', 'from core'),
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.config', 'from core.config'),
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.execution', 'from core.execution'),
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.state', 'from core.state'),
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.adapters', 'from core.adapters'),
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.workstreams', 'from core.workstreams'),
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.ast', 'from core.ast'),
        (r'from UNIVERSAL_EXECUTION_TEMPLATES_FRAMEWORK\.core\.engine', 'from core.engine'),
