...
{'✅ **All workstreams synced successfully**' if self.summary['errors_count'] == 0 else f"⚠️ **{self.summary['errors_count']} errors occurred during sync**"}
...
"""
    ...
    def run(self):
        ...
        try:
            ...
            print(f"✅ Successes: {self.summary['success_count']}")
            print(f"❌ Errors: {self.summary['errors_count']}")
