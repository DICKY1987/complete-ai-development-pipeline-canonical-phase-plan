# Test: PAT-META-phase_plan_pattern_governance-1020 Executor
# DOC_ID: DOC-PAT-META-phase_plan_pattern_governance-1020
# Generated: 2025-12-08

Describe "Phase Plan Pattern Governance Executor Tests" {
    BeforeAll {
        $ExecutorPath = Join-Path $PSScriptRoot "..\executors\phase_plan_pattern_governance_executor.ps1"
        $PatternID = "PAT-META-phase_plan_pattern_governance-1020"
        $DocID = "DOC-PAT-META-phase_plan_pattern_governance-1020"
    }
