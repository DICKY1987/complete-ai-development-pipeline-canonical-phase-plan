# Test: PAT-ANTI-doc_anti_patterns-1003 Executor
# DOC_ID: DOC-PAT-ANTI-doc_anti_patterns-1003
# Generated: 2025-12-08

Describe "Doc Anti Patterns Executor Tests" {
    BeforeAll {
        $ExecutorPath = Join-Path $PSScriptRoot "..\executors\doc_anti_patterns_executor.ps1"
        $PatternID = "PAT-ANTI-doc_anti_patterns-1003"
        $DocID = "DOC-PAT-ANTI-doc_anti_patterns-1003"
    }
