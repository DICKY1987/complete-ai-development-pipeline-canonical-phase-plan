...
class MockDB:
    ...
    def _init_schema(self):
        ...
        schema_path = Path(__file__).parent.parent.parent / 'schema' / 'migrations' / '004_add_test_gates_table.sql'
...
class TestGateCreation:
    ...
    def test_create_gate_all_types(self, gate_manager):
        ...
        types = ['unit_tests', 'integration_tests', 'e2e_tests', 'security_scan', 'lint', 'custom']
...
class TestGateListing:
    ...
    def test_list_gates_by_state(self, gate_manager):
        ...
        criteria = GateCriteria()
        gate_manager.create_gate("01HQGATE00000000000000001", "Test 1", "unit_tests", criteria)
        gate_manager.create_gate("01HQGATE00000000000000002", "Test 2", "unit_tests", criteria)
    ...
    def test_list_gates_by_type(self, gate_manager):
        ...
        criteria = GateCriteria()
        gate_manager.create_gate("01HQGATE00000000000000001", "Test 1", "unit_tests", criteria)
        gate_manager.create_gate("01HQGATE00000000000000002", "Test 2", "integration_tests", criteria)
    ...
    def test_list_gates_by_project(self, gate_manager):
        ...
        criteria = GateCriteria()
        gate_manager.create_gate("01HQGATE00000000000000001", "Test 1", "unit_tests", criteria, project_id="proj-a")
        gate_manager.create_gate("01HQGATE00000000000000002", "Test 2", "unit_tests", criteria, project_id="proj-b")
