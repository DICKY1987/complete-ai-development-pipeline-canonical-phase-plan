...
# Module metadata
__module_id__ = "error-plugin-python-mypy"
__ulid_prefix__ = "010012"
__layer__ = "ui"
module_import_name = "error_plugin_python_mypy"
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.error_plugin_python_mypy.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.error_plugin_python_mypy.{_alias}"] = _mod
                globals()[_alias] = _mod
