...
# Module metadata
__module_id__ = "error-plugin-powershell-pssa"
__ulid_prefix__ = "01000E"
__layer__ = "ui"
module_import_name = "error_plugin_powershell_pssa"
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.error_plugin_powershell_pssa.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.error_plugin_powershell_pssa.{_alias}"] = _mod
                globals()[_alias] = _mod
