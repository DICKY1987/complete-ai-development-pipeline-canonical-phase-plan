...
# Module metadata
__module_id__ = "core-ast"
__ulid_prefix__ = "010000"
__layer__ = "domain"
module_import_name = "core_ast"
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.core_ast.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.core_ast.{_alias}"] = _mod
                globals()[_alias] = _mod
