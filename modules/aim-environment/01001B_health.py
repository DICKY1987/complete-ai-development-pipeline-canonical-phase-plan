...
from modules.aim_environment.01001B_exceptions import HealthCheckError
...
class HealthMonitor:
    ...
    def check_ai_tools(self) -> HealthCheck:
        ...
        """
        try:
            from modules.aim_registry.01001C_config_loader import get_config_loader
    ...
    def check_secrets_vault(self) -> HealthCheck:
        ...
        """
        try:
            from modules.aim_environment.01001B_secrets import get_secrets_manager
