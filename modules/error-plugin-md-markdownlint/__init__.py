...
# Module metadata
__module_id__ = "error-plugin-md-markdownlint"
__ulid_prefix__ = "01000B"
__layer__ = "ui"
module_import_name = "error_plugin_md_markdownlint"
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.error_plugin_md_markdownlint.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.error_plugin_md_markdownlint.{_alias}"] = _mod
                globals()[_alias] = _mod
