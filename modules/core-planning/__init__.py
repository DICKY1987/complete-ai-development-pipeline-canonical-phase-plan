...
# Module metadata
__module_id__ = "core-planning"
__ulid_prefix__ = "010002"
__layer__ = "domain"
module_import_name = "core_planning"

# Dynamically import all ULID-prefixed files and re-export
_module_dir = Path(__file__).parent
_ulid_files = [
"m010002_archive",
"m010002_ccpm_integration",
"m010002_parallelism_detector",
"m010002_planner",
]
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.core_planning.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.core_planning.{_alias}"] = _mod
                globals()[_alias] = _mod
