"""Module: error-plugin-md-mdformat-fix
...
# Module metadata
__module_id__ = "error-plugin-md-mdformat-fix"
__ulid_prefix__ = "01000C"
__layer__ = "ui"
module_import_name = "error_plugin_md_mdformat_fix"
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.error_plugin_md_mdformat_fix.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.error_plugin_md_mdformat_fix.{_alias}"] = _mod
                globals()[_alias] = _mod
