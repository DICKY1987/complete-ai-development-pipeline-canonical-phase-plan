...
**Patch File**: `glossary-updates/add-uet-schemas.patch`
...
**Patch File**: `glossary-updates/add-engine-paths.patch`
...
- **[DOC_GLOSSARY_GOVERNANCE.md](DOC_GLOSSARY_GOVERNANCE.md)** - Governance framework
- **[DOC_GLOSSARY_SCHEMA.md](DOC_GLOSSARY_SCHEMA.md)** - Term schema
