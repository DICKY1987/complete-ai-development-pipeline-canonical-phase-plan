...
module_refs: []
script_refs: []
doc_id: DOC-GUIDE-GLOSSARY_GOVERNANCE-056
---
...
docs/
  DOC_GLOSSARY_GOVERNANCE.md         # This document (governance)
...
scripts/
  glossary/
    ...
    update_term.py                   # Patch-based term updates
    extract_terms.py                 # Auto-extract terms from code
config/
...
The main `glossary.md` follows this canonical structure:
...
**Actions**:
- Create term proposal in `.glossary-metadata.yaml`
- Assign term ID
- Set status = `proposed`
...
2. Update `last_modified` in metadata
3. Add entry to `DOC_GLOSSARY_CHANGELOG.md`
4. Run `python scripts/glossary/validate_glossary.py`
5. Commit with message: `docs(glossary): <description>`
...
1. Create patch specification:
   ```yaml
   # glossary-updates/update-001.yaml
   patch_id: "01J4XY..."
...
4. Apply patch:
   ```bash
   git apply glossary-updates/update-001.patch
   ```
...
1. Scan code for new terms:
   ```bash
   python scripts/glossary/extract_terms.py --scan core/ engine/ error/
   ```
...
**Location**: `scripts/glossary/validate_glossary.py`
...
**Location**: `scripts/glossary/generate_glossary_index.py`
...
**Usage**:
```bash
python scripts/glossary/generate_glossary_index.py
```

### Patch Generation

**Location**: `scripts/glossary/update_term.py`
...
See **[DOC_GLOSSARY_SCHEMA.md](DOC_GLOSSARY_SCHEMA.md)** for:
...
See **[DOC_GLOSSARY_CHANGELOG.md](DOC_GLOSSARY_CHANGELOG.md)** for:
...
### Core References
- **[glossary.md](../glossary.md)** - Main glossary (user-facing)
- **[DOC_GLOSSARY_SCHEMA.md](DOC_GLOSSARY_SCHEMA.md)** - Term schema definition
- **[DOC_GLOSSARY_CHANGELOG.md](DOC_GLOSSARY_CHANGELOG.md)** - Update history
...
### Tool Documentation
- **Validation Tool**: `scripts/glossary/README.md`
- **Patch Tool**: `scripts/glossary/update_term.py --help`
- **Extract Tool**: `scripts/glossary/extract_terms.py --help`
...
python scripts/glossary/add_term.py

# Update term
python scripts/glossary/update_term.py --term TERM-ENGINE-001

# Extract new terms from code
python scripts/glossary/extract_terms.py --scan core/
...
docs/DOC_GLOSSARY_*.md             # Governance docs
.glossary-metadata.yaml            # Term metadata (git-tracked)
scripts/glossary/                  # Tooling
config/glossary_policy.yaml        # Validation rules
```
