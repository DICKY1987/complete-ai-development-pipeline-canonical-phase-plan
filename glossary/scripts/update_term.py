...
GLOSSARY_FILE = GLOSSARY_ROOT / 'glossary.md'
METADATA_FILE = GLOSSARY_ROOT / '.glossary-metadata.yaml'
CHANGELOG_FILE = GLOSSARY_ROOT / 'docs' / 'DOC_GLOSSARY_CHANGELOG.md'
...
class GlossaryPatcher:
    ...
    def _update_field(self, term_id: str, term_data: Dict, field: str, value: Any) -> bool:
    ...
    def _add_to_field(self, term_id: str, term_data: Dict, field: str, value: Any) -> bool:
    ...
    def _remove_from_field(self, term_id: str, term_data: Dict, field: str, value: Any) -> bool:
    ...
    def _replace_field(self, term_id: str, term_data: Dict, field: str, value: Any) -> bool:
    ...
    def validate(self) -> bool:
        ...
        try:
            result = subprocess.run(
                ['python', str(SCRIPT_DIR / 'validate_glossary.py'), '--quick'],
                cwd=GLOSSARY_ROOT,
                capture_output=True,
                text=True,
                timeout=60
...
Examples:
  ...
  python update_term.py --spec updates/add-schemas.yaml --apply --validate
    ...
    parser.add_argument('--validate', action='store_true', help='Run validation after update')
    ...
    if args.spec:
        # Patch spec mode
        spec_path = GLOSSARY_ROOT / 'updates' / args.spec if '/' not in args.spec else Path(args.spec)
        ...
        # Single term mode
        if single_term_update(args.term, args.field, args.value, dry_run=args.dry_run or not args.apply):
