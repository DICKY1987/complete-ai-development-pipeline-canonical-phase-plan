...
- **Components**: glossary_metadata, validate_glossary, extract_terms, SSOT policy
...
| Component | File | Role |
|-----------|------|------|
| **glossary_metadata** | `.glossary-metadata.yaml` | Machine-readable term registry (83 terms) |
| **glossary_governance** | `DOC_GLOSSARY_GOVERNANCE.md` | Governance framework and lifecycle policies |
| **glossary_schema** | `DOC_GLOSSARY_SCHEMA.md` | JSON Schema definition for term structure |
| **glossary_changelog** | `DOC_GLOSSARY_CHANGELOG.md` | Version history and change tracking |
| **validate_glossary** | `scripts/glossary/validate_glossary.py` | Full validation tool (structure, quality, refs) |
| **extract_terms** | `scripts/glossary/extract_terms.py` | Automated term extraction from code/markdown |
| **update_term** | `scripts/glossary/update_term.py` | Programmatic term updates |
...
```bash
python scripts/glossary/update_term.py --term-id TERM-XXX-NNN
```
...
| **Metadata** | `.glossary-metadata.yaml` | YAML | Machine-readable term registry (83 terms) |
...
| **Scripts** | `scripts/glossary/*.py` | Python | Automation tools (validation, extraction, updates) |
| **Changelog** | `DOC_GLOSSARY_CHANGELOG.md` | Markdown | Version history and quality metrics tracking |
...
### 1. Manual Updates
- Direct edits to .glossary-metadata.yaml
...
- `DOC_GLOSSARY_SCHEMA.md` - JSON Schema definition
- `DOC_GLOSSARY_CHANGELOG.md` - Version history
- `.glossary-metadata.yaml` - Term registry (83 terms)
- `scripts/glossary/README.md` - Tooling documentation
