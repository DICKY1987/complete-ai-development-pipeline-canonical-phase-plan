...
class TestSCAAnalyzer:
    ...
    def test_analyze_python_pip_audit(self, mock_get_registry, tmp_path):
        ...
        assert metrics.vulnerabilities_by_severity["high"] == 2
    ...
    @patch("coverage_analyzer.analyzers.sca.get_registry")
    def test_log_critical_vulnerabilities(
        ...
        assert metrics.vulnerabilities_by_severity["critical"] == 2
