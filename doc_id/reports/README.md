...
**docs_inventory.jsonl** 🔄 **GENERATED - DO NOT EDIT MANUALLY**
...
**DOC_ID_COVERAGE_REPORT.md** 📊 **GENERATED**
...
- ✅ `docs_inventory.jsonl` (current state)
- ✅ `DOC_ID_COVERAGE_REPORT.md` (current coverage)
- ✅ `doc_id_mapping.json` (current mapping)
- ✅ Phase completion reports

### Archive

- 📦 Dated coverage snapshots (after 30 days)
- 📦 Old validation reports (after resolution)

### Delete

- 🗑️ Temporary reports (after use)
- 🗑️ Duplicate reports
...
- ✅ Easy to parse (`jq`, `grep`)
- ✅ Append-friendly (if needed)
- ✅ No array wrapper (efficient for large files)
