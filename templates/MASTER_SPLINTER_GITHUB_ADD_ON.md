---
doc_id: DOC-GUIDE-MASTER-SPLINTER-GITHUB-ADD-ON-526
---
...
- pattern_id: "PAT-GH-SYNC-PHASE-001"
  ...
  spec_path: ".github/github_integration_v2/specs/GH_SYNC_PHASE_V1.pattern.yaml"
  schema_path: "patterns/schemas/GH_SYNC_PHASE_V1.schema.json"
  executor_path: ".github/github_integration_v2/executors/phase_sync.py"
  test_path: ".github/github_integration_v2/tests/GH_SYNC_PHASE_V1_test.py"
  example_dir: ".github/github_integration_v2/docs/"
...
1. **Pattern Registry & Specs**
   ...
   1.2. For `PAT-GH-SYNC-PHASE-001` (`GH_SYNC_PHASE_V1`):
        ...
        - Ensure `executor_path` exists (e.g. `.github/github_integration_v2/executors/phase_sync.py`).
