---
doc_id: DOC-GUIDE-ARCHITECTURE-566
---

# bootstrap_orchestrator Architecture

**Module**: bootstrap_orchestrator

## Overview

Detects repository type, selects appropriate profile, validates baseline configuration
