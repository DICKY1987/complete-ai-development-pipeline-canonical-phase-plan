...
class WorkerStateMachine(BaseStateMachine):
    ...
    def __init__(self, worker_id: str, worker_type: str = "orchestration", metadata: Optional[Dict] = None):
        super().__init__(
            entity_id=worker_id,
            entity_type="worker",
    ...
    def assign_task(self, task_id: str):
        ...
        self.transition(WorkerState.BUSY, reason=f"Assigned task {task_id}", trigger="task_assigned")
    
    def complete_task(self):
        """Complete current task."""
        self.current_task_id = None
        self.transition(WorkerState.IDLE, reason="Task completed", trigger="task_completed")
    ...
    def recover(self):
        ...
        self.transition(WorkerState.IDLE, reason="Worker recovered", trigger="recovered")
    
    def shutdown(self):
        """Shutdown worker."""
        self.transition(WorkerState.SHUTDOWN, reason="Worker shutdown", trigger="shutdown")
        self.current_task_id = None
