...
class CircuitBreakerState(BaseState):
    ...
    def get_valid_transitions(
        cls,
    ) -> Dict["CircuitBreakerState", Set["CircuitBreakerState"]]:
        """
    ...
    def call(self, func: Callable, *args, **kwargs) -> Any:
        ...
        if self.current_state == CircuitBreakerState.OPEN:
            if self._should_attempt_reset():
                ...
                raise CircuitBreakerOpenError(self.tool_id, self._seconds_until_reset())
        ...
        if self.current_state == CircuitBreakerState.HALF_OPEN:
            ...
            if self.success_count >= self.success_threshold:
                ...
                self.transition(
                    ...
                    reason="Test request succeeded, closing circuit",
    ...
    def _on_failure(self):
        ...
        if self.current_state == CircuitBreakerState.HALF_OPEN:
            ...
            self.transition(
                ...
                reason="Test request failed, reopening circuit",
                trigger="test_failed",
            )
            self.success_count = 0
