...
# Module metadata
__module_id__ = "error-plugin-js-eslint"
__ulid_prefix__ = "010009"
__layer__ = "ui"
module_import_name = "error_plugin_js_eslint"
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.error_plugin_js_eslint.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.error_plugin_js_eslint.{_alias}"] = _mod
                globals()[_alias] = _mod
