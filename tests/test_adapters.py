...
@pytest.fixture
def sample_task():
    return {'mode': 'prompt', 'payload': {'files': ['src/test.py'], 'description': 'Test task'}, 'timeouts': {'wall_clock_sec': 300}}
...
def test_execution_result_creation():
    result = ExecutionResult(success=True, exit_code=0, stdout='output', stderr='', duration_sec=1.5)
