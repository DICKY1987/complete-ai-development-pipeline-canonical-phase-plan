...
class TestCostRecording:
    ...
    def test_record_basic_cost(self, tracker, cost_id):
        ...
        result = tracker.record_cost(
            cost_id=cost_id, resource_type="api_call", amount=1.50, currency="USD"
        )
    ...
    def test_record_cost_with_usage(self, tracker, cost_id):
        ...
        tracker.record_cost(
            cost_id=cost_id, resource_type="api_call", amount=usage.cost, usage=usage
        )
    ...
    def test_record_cost_with_metadata(self, tracker, cost_id):
        ...
        metadata = {"model": "gpt-4", "tokens_input": 500, "tokens_output": 200}
    ...
    def test_record_invalid_currency(self, tracker, cost_id):
        ...
        with pytest.raises(ValueError, match="Currency"):
            tracker.record_cost(
                cost_id, "api_call", 1.00, currency="usd"
            )  # Not uppercase
...
class TestCostAggregation:
    ...
    def test_total_cost_by_project(self, tracker, project_id):
        ...
        tracker.record_cost(
            "01HQCOST00000000000000001", "api_call", 1.50, project_id=project_id
        )
        tracker.record_cost(
            "01HQCOST00000000000000002", "api_call", 2.00, project_id=project_id
        )
        tracker.record_cost(
            "01HQCOST00000000000000003", "api_call", 1.00, project_id="other"
        )
    ...
    def test_total_cost_different_currency(self, tracker):
        ...
        tracker.record_cost(
            "01HQCOST00000000000000001", "api_call", 1.50, currency="USD"
        )
        tracker.record_cost(
            "01HQCOST00000000000000002", "api_call", 2.00, currency="EUR"
        )
...
class TestCostListing:
    ...
    def test_list_costs_by_request(self, tracker, request_id):
        ...
        tracker.record_cost(
            "01HQCOST00000000000000002", "api_call", 2.00, execution_request_id="other"
        )
    ...
    def test_list_costs_by_project(self, tracker, project_id):
        ...
        tracker.record_cost(
            "01HQCOST00000000000000002", "api_call", 2.00, project_id="other"
        )
